...
export const metadata: Metadata = {
  ...
  description: 'Browse AiSprint\'s AI education programs. 1:1 live mentorship in Machine Learning, AI, and Prompt Engineering.',
}
      ...
      <section className="bg-mesh pt-20 pb-16">
        <div className="container-custom max-w-4xl text-center">
          ...
          <p className="section-subheading mx-auto">
            Both programs offer 1:1 live mentorship with industry experts and full placement support. The difference is depth, duration, and target role.
          </p>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={course.title} className="bg-white rounded-3xl border-2 border-gray-100 hover:border-brand-200 hover:shadow-xl transition-all duration-300 overflow-hidden">
                <div className="p-8">
                  ...
                  <h2 className="font-heading text-2xl font-bold text-neutral-950 mb-1">{course.title}</h2>
                  <p className="text-xs font-semibold text-brand-500 font-body mb-3 uppercase tracking-wide">{course.subtitle}</p>
                  <p className="text-xs text-gray-500 font-body italic mb-5">Best for: {course.for}</p>

                  <div className="flex gap-4 mb-5">
                    <div>
                      <p className="text-xs text-gray-400 font-body">Duration</p>
                      <p className="text-sm font-semibold text-gray-800 font-body">{course.duration}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-400 font-body">Live 1:1 Sessions</p>
                      <p className="text-sm font-semibold text-gray-800 font-body">{course.sessions}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-end justify-between mb-5">
                    <div>
                      <p className="text-xs text-gray-400 font-body">Investment</p>
                  ...
                  <div className="flex gap-3">
                    ...
                    <Link href={course.href} className="px-4 py-3 rounded-xl border border-gray-200 text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors font-body">
                      Details
                    </Link>
                  </div>
                </div>
          ...
          <div className="mt-16 max-w-3xl mx-auto p-8 bg-gray-50 rounded-3xl text-center border border-gray-100">
            <p className="text-gray-600 font-body mb-4 text-sm">
              Not sure which program is right for you? Book a free 15-minute advisory call with our admissions team.
            </p>
