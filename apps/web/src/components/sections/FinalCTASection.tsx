...
export default function FinalCTASection() {
  return (
    <section className="section-padding relative overflow-hidden bg-dark-mesh">
      {/* Noise overlay */}
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="flex justify-center gap-2 mb-6">
            <span className="badge bg-brand-900/80 text-brand-300">🚀 Startup India Partner</span>
            <span className="badge bg-brand-900/80 text-brand-300">🎓 Swayam Recognized</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/ml-ai/apply"
              className="btn-accent px-8 py-4 text-base font-semibold"
            >
            ...
            <Link
              ...
              className="btn-secondary px-8 py-4 text-base border-white/20 text-white hover:bg-white/10"
            >
