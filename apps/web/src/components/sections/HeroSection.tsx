...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-16 pb-24 md:pt-20 md:pb-28 lg:pt-24 lg:pb-32">
...
<span className="flex items-center gap-2">
  ...
  <span>94% Placement Rate</span>
          ...
          {/* Headline */}
<h1 className="text-2xl md:text-3xl lg:text-4xl font-heading font-semibold text-text-primary mb-6">
Learn AI With a Dedicated Mentor
</h1>
<p className="text-lg text-text-body leading-relaxed mb-10">
  No boring pre-recorded lectures. <br></br> Just real 1:1 live sessions with experts <br></br> from Google, Amazon, and top Indian tech teams.
</p>
...
<div className="relative w-5 h-5">
  ...
  {/* filled portion (65%) */}
  <div className="absolute overflow-hidden w-[65%]">
    <svg
      className="w-5 h-5 text-amber-400 fill-current"
      viewBox="0 0 20 20"
    >
